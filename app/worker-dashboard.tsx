...
export default function WorkerDashboardScreen() {
  ...
  const { workerProfile, setLogoutModalVisible } = useSession();
  ...
  const handleAcceptJob = (jobTitle: string) => {
    Alert.alert(
      'Job Accepted!',
      `You accepted "${jobTitle}". Customer details and address are now accessible.`,
      [{ text: 'OK' }]
    );
  };
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View>
            <View style={styles.nameRow}>
              <Text style={styles.workerName}>{workerProfile.name}</Text>
              <MaterialIcons name="verified" size={16} color={COLORS.primary} />
            </View>
            <Text style={styles.workerTitle}>{workerProfile.trade} Specialist • 4.9 ★</Text>
          </View>
        </View>
        ...
        <View style={styles.headerRight}>
          <TouchableOpacity
            ...
            activeOpacity={0.8}>
            <Ionicons name="people" size={14} color={COLORS.accentOrange} />
      ...
      <ScrollView
        ...
        <View style={styles.statusCard}>
          <View style={styles.statusInfo}>
            ...
            <Text style={styles.statusDesc}>
              {isOnline
                ? `Receiving instant requests within ${workerProfile.serviceRadius} km radius`
        ...
        <View style={styles.urgentBanner}>
          ...
          <View style={styles.urgentFooter}>
            ...
            <TouchableOpacity
              ...
              onPress={() => handleAcceptJob('Kitchen sink pipe leaking')}
              activeOpacity={0.85}>
        ...
        <View style={styles.statsCard}>
          <View style={styles.statsHeader}>
            ...
            <Text style={styles.statsDate}>Today</Text>
          </View>
        ...
        <View style={styles.sectionHeader}>
          <View>
            ...
            <Text style={styles.sectionSubtitle}>Tap accept to take jobs in your trade</Text>
          </View>
